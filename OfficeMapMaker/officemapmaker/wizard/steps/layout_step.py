...
# ---------------------------------------------------------------------------
# Pan/zoom preview view
# ---------------------------------------------------------------------------


class _PreviewGraphicsView(QtWidgets.QGraphicsView):
    """Read-only pan/zoom view of the rendered layout preview.
...
class LayoutStep(StepBase):
    ...
    def _build_results_pane(self) -> QtWidgets.QWidget:
        ...
        self._preview_view = _PreviewGraphicsView(preview_container)
